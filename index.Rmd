...
```{r load_lib, echo = FALSE, results='hide'}
library(ggplot2)
library(caret)
```

```{r price_vs_carat, fig.height= 4, fig.align = "center", message=FALSE, warning=FALSE, cache = TRUE}
...
```{r price_carat_adjforcutandcolor, fig.height = 6, fig.width = 10, fig.align = 'center', message = FALSE}
...
```{r pricing_model, cache = TRUE, message = FALSE}
vars <- diamonds[,1:4]
